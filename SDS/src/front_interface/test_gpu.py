...
All credit for this AMAZING script that I amended for this
as follows:
...
def main():
    ...
    ### Declares number of GPUs
    # print("Found %d device(s)." % nGpus.value)

    ### If CUDA has been successful:
    ...
    for i in range(nGpus.value):
        ...
        gpu_information.append(totalMem.value)
